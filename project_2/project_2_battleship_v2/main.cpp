...
int main(int argc, char** argv) {
   ...
   // const string P2 = "Player 2 ";
    ...
    const int SIZE=7;
    string p2Names[SIZE]={"BART", "JANIS", "STEPHANIE", "TING","VICTOR", "JILLIAN", "JOHN"};
   ...
   getName(p1Name);   
   p2Name = pickP2(p2Names,SIZE);
   cout << setw(12) << p1Name << " vs " << p2Name << endl;
   
   const int SIZE2=8;
   string names[SIZE2];
   copyAdd(p2Names,SIZE,names,SIZE2,p1Name);
   for(string n:names){        
        cout << n << " ";
   }    
...
void copyAdd(string p2Names[],const int SIZE, string names[], const int SIZE2, string p1Name){
...
string pickP2(string p2Names[]){
    
    cout << "\nLocating your opponent online......\n";    
    int indx=rand()%(7+1);    
    string temp = p2Names[indx];
    return temp;
}

// randomly picks a name from an array as player 2's name
string pickP2(string p2Names[], int SIZE){
    
    cout << "\nLocating your opponent online......\n";    
    string name2=p2Names[rand()%(SIZE)]; 
